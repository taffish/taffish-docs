...
Install the current TAFFISH release, `0.10.0` or later, for the current MCP tool surface:
...
TAFFISH `0.9.0` and later also allow MCP server environments to include
