...
- Only index-side display metadata or upstream attribution fields for an already
  published immutable version are supplemented through `metadata-overrides.toml`.
